...
3. **clause**: GDPR.Art 6
4. **depends_on**: (none)
5. **sample**: The document states processing is based on consent obtained via the opt-in checkbox on the registration form [S1.c4]. This is a valid legal basis under GDPR.Art 6(1)(a).
...
3. **clause**: GDPR.Art 9
4. **depends_on**: (none)
5. **sample**: The document mentions processing of health data for insurance purposes [S1.c5]. This triggers GDPR.Art 9 requirements for an explicit consent basis.
...
3. **clause**: GDPR.Art 35
4. **depends_on**: special_category_data
5. **sample**: Since special category data is being processed, a DPIA is required under GDPR.Art 35(3)(b). The document does not mention one [S1.c6].

### dpo_appointed
1. **type**: enum(required, appointed, not_required)
2. **description**: Has a Data Protection Officer been appointed?
3. **clause**: GDPR.Art 37
4. **depends_on**: (none)
5. **sample**: The document mentions a DPO contact at dpo@acme.com [S1.c8], complying with GDPR.Art 37(7).

### data_subject_access
1. **type**: enum(available, partial, missing)
2. **description**: Is there a mechanism for data subjects to access their data?
3. **clause**: GDPR.Art 15
4. **depends_on**: (none)
5. **sample**: A data subject access request procedure is described on page 3 [S1.c9], providing the required mechanisms under GDPR.Art 15.

### international_transfer
1. **type**: enum(adequacy, scc, bcr, none)
2. **description**: Are there safeguards for international data transfers?
3. **clause**: GDPR.Art 44-49
4. **depends_on**: (none)
5. **sample**: The document states data is transferred to the US under Standard Contractual Clauses referenced in Appendix B [S1.c10], satisfying GDPR.Art 46 requirements.

### breach_notification_72h
1. **type**: boolean
2. **description**: Does the document commit to notifying the DPA within 72 hours of a breach?
3. **clause**: GDPR.Art 33(1)
4. **depends_on**: (none)
5. **sample**: The breach notification policy states the DPA will be notified within 72 hours of breach detection [S1.c11], as required by GDPR.Art 33(1).

### record_retention_years
1. **type**: number(0-50)
2. **description**: Years retained after relationship ends
3. **clause**: GDPR.Art 5(1)(e)
4. **constraint**: >= 5
5. **depends_on**: (none)
