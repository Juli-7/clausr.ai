 ...
 *
 * Includes step instructions, dependency context (previous results this step
 * depends on), optional revision context with previous output, and any
 * available file chunks the LLM should reference.
 */
